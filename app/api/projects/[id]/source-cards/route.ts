...
export async function POST(request: Request, context: RouteContext) {
  try {
    ...
    const card: SourceCard = {
      ...
      supportLevel: body.supportLevel || "medium",
      claimType: body.claimType || "fact",
      timeSensitivity: body.timeSensitivity || "timely",
      intendedSection: body.intendedSection?.trim() || "",
      reliabilityNote: body.reliabilityNote?.trim() || "",
