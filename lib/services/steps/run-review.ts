...
function mergeReviews(base: ReviewReport, extra: ReviewReport): ReviewReport {
  ...
  return {
    ...
    continuityFlags: base.continuityFlags,
    structuralRewriteIntents: base.structuralRewriteIntents,
    deferredStructuralRewriteIntents: base.deferredStructuralRewriteIntents,
